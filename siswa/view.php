    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header row">
                ...
                <div class="col-4">
                    <a href="?m=siswa&s=add" class="btn btn-large btn-primary float-end"><b>+</b></a>
                </div>
            </div>
                        ...
                        <?php
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($r = mysqli_fetch_assoc($result)) {
                                    $foto = isset($r['foto']) ? $r['foto'] : 'non.jpg';
                                    echo '<tr>
                                            <td>'.$no.'</td>
                                            <td>'.$r['nis'].'</td>
                                            <td>'.$r['nama'].'</td>
                                            ...
                                            <td>'.$r['kelas'].'</td>
                                            <td><img width="100px" style="object-fit:cover; aspect-ratio: 1/1;" src="siswa/foto/'. $foto     .'"> </td>
                                            <td>
